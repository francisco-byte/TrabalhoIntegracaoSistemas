...
class ProdutoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.UpdateProduto = channel.unary_unary(
                '/ProdutoService/UpdateProduto',
                request_serializer=produtos__pb2.Produto.SerializeToString,
                response_deserializer=produtos__pb2.Resposta.FromString,
...
def add_ProdutoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateProduto': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateProduto,
                    request_deserializer=produtos__pb2.Produto.FromString,
                    response_serializer=produtos__pb2.Resposta.SerializeToString,
            ),
    }
...
class ProdutoService(object):
    ...
    def UpdateProduto(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            produtos__pb2.Resposta.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
